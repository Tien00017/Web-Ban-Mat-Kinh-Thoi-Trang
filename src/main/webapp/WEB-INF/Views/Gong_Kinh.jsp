...
<head>
    ...
    <title>Gọng Kính - Mắt Kinh Nông Lâm</title>
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/StyleOfGong_Kinh.css">
...
<header class="site-header">
    ...
    <nav class="category-bar">
        ...
        <a href="${pageContext.request.contextPath}/Gong_Kinh" class="cat active">Gọng Kính</a>
    </nav>
</header>
...
<div class="container">
    ...
    <form method="get"
          action="${pageContext.request.contextPath}/Gong_Kinh"
          class="sidebar">
        ...
        <div class="pagination">
            <c:if test="${totalPages > 1}">
                ...
                <c:if test="${currentPage > 1}">
                    <a href="${pageContext.request.contextPath}/Gong_Kinh?material=${param.material}&shape=${param.shape}&priceRange=${param.priceRange}&sortPrice=${param.sortPrice}&page=1"
                       class="page-nav">&lt;&lt;</a>
                </c:if>

                <!-- Nút trang trước -->
                <c:if test="${currentPage > 1}">
                    <a href="${pageContext.request.contextPath}/Gong_Kinh?material=${param.material}&shape=${param.shape}&priceRange=${param.priceRange}&sortPrice=${param.sortPrice}&page=${currentPage - 1}"
                       class="page-nav">&lt;</a>
                </c:if>
                ...
                <c:forEach begin="<%=start%>" end="<%=end%>" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="${pageContext.request.contextPath}/Gong_Kinh?material=${param.material}&shape=${param.shape}&priceRange=${param.priceRange}&sortPrice=${param.sortPrice}&page=${i}"
                               class="page">${i}</a>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:if test="${end < totalPages}">
                    <span class="dots">…</span>
                    <a href="${pageContext.request.contextPath}/Gong_Kinh?material=${param.material}&shape=${param.shape}&priceRange=${param.priceRange}&sortPrice=${param.sortPrice}&page=${totalPages}"
