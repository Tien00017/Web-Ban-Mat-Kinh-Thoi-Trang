...
<head>
    ...
    <link rel="stylesheet" href="../src/main/webapp/CSS/StyleOfGong_Kinh.css">
...
<header class="site-header">
    ...
    <nav class="category-bar">
        ...
        <a href="Gong_Kinh.html" class="cat active">Gọng Kính</a>
    </nav>
</header>
    ...
    <aside class="sidebar">
        ...
        <h4>Chất liệu</h4>
        <label><input type="radio" name="chatlieu"> Kim loại</label>
        <label><input type="radio" name="chatlieu"> Nhựa</label>
        <label><input type="radio" name="chatlieu"> Titan</label>

        <h4>Hình dáng</h4>
        <label><input type="radio" name="hinhdang"> Vuông</label>
        <label><input type="radio" name="hinhdang"> Tròn</label>
        <label><input type="radio" name="hinhdang"> Oval</label>
        <label><input type="radio" name="hinhdang"> Mắt mèo</label>
    ...
    <section class="products">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                ...
                <img src="../src/main/webapp/Images/GongKinh/GongKinh1.png" alt="Metal Frame">
                <h4>Metal Frame Slim</h4>
                <p class="price">580,000 VNĐ</p>
            ...
            <div class="product-card">
                ...
                <img src="../src/main/webapp/Images/GongKinh/GongKinh2.jpg" alt="Round Retro">
                <h4>Round Retro</h4>
                <p class="price">490,000 VNĐ</p>
                <p class="rating">⭐ 4.8</p>
                <a href="ProductDetail.html" class="try-btn">Xem sản phẩm</a>
            ...
            <div class="product-card">
                ...
                <img src="../src/main/webapp/Images/GongKinh/GongKinh3.png" alt="Cat Eye Slim">
                <h4>Cat Eye Slim</h4>
