...
<head>
    ...
    <link rel="stylesheet" href="../src/main/webapp/CSS/StyleOfKinh_Mat.css">
...
<header class="site-header">
    ...
    <nav class="category-bar">
        ...
        <a href="Kinh_Mat.html" class="cat active">Kính Mát</a>
    ...
    <div class="container">
      <aside class="sidebar">
        ...
        <h4>Màu Kính</h4>
            ...
            <label><input type="radio" name="mau"> Nâu</label>
            <label><input type="radio" name="mau"> Xám</label>
    ...
    <div class="product-grid">
        ...
        <div class="product-card">
            ...
            <img src="../src/main/webapp/Images/KinhMat/KinhMat1.jpg">
            <h4>Black Shades</h4>
            <p class="price">750,000 VNĐ <span class="old-price">980,000 VNĐ</span></p>
        ...
        <div class="product-card">
            ...
            <img src="../src/main/webapp/Images/KinhMat/KinhMat2.jpg">
            <h4>Brown Retro</h4>
        ...
        <div class="product-card">
            ...
            <img src="../src/main/webapp/Images/KinhMat/KinhMat3.jpg">
            <h4>Sport UV Pro</h4>
